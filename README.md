...
SmolVLM — Hugging Face Documentation

SmolVLM — Hugging Face Blog
...
Implementations of the supported models
...
Generated masks and processed results
...
Model and project configuration files
...
Script for running the implemented models
...
CriterionEfficientTAMnanoVLMSmolVLM
...
Official EfficientTAM Repository

nanoVLM

Hugging Face — nanoVLM.

Official nanoVLM Repository

nanoVLM Introduction

SmolVLM

Hugging Face — SmolVLM.

SmolVLM Documentation

SmolVLM Introduction
...
Project Repository: video-segmentation-lightweight
