...
class NanoVLMInference:
    def __init__(self, model_path="checkpoints/nanovlm/model_best.pth"):
        ...
        self.model.eval()
        print(f"✅ nanoVLM (Florence-2) loaded for text generation")
    ...
    def process_video(self, video_path, output_dir="outputs/text"):
        ...
        if video_path.is_dir():
            ...
            txt_path = output_dir / f"nano.{image_name}.txt"
            with open(txt_path, 'w', encoding='utf-8') as f:
                f.write(desc)
            results = [{
        ...
        print(f"✅ nanoVLM output saved to: {txt_path}")
        return results
